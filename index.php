...
echo $produit1;  // Doit afficher 1;iPhone 11;1400;9 echo $produit2;  // Doit afficher 2;M2 SSD;400;2 echo "Nombre de produits dans le panier: " . PHP_EOL; echo $panier->getQuantiteTotale() . PHP_EOL; // Doit afficher 3 echo "Prix total des produits dans le panier: " . PHP_EOL; echo $panier->getTotal() . PHP_EOL; // Doit afficher 2200

$lignePanier1->incrementerQuantite();
$lignePanier2->incrementerQuantite(3);

echo $produit1;  // Doit afficher 1;iPhone 11;1400;8 echo $produit2;  // Doit afficher 2;M2 SSD;400;2
...
echo "Nombre de produits dans le panier: " . PHP_EOL;
echo $panier->getQuantiteTotale() . PHP_EOL; // Doit afficher 2 echo $produit1; // Doit afficher 1;iPhone 11;1400;10 echo $produit2; // Doit afficher 2;M2 SSD;400;2
